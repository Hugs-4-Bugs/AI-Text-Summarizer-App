...
function submitData(e) {
  ...
  fetch('https://4af03de2-5977-49ce-bf8f-070a01f6b032-00-2t5jj6dty8259.sisko.replit.dev/summarize', requestOptions)
    ...
    .catch(error => {
      ...
      // Stop the spinning loading animation in case of error
      submitButton.classList.remove("submit-button--loading");
    });
}
